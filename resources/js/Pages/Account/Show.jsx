                ...
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="overflow-hidden max-w-xs mx-auto bg-white shadow-sm sm:rounded-lg dark:bg-gray-800">
                        <div className="p-6 text-gray-900 dark:text-gray-100 text-center">
                            ...
                            <p className="font-bold font-serif">{account.CustomerName}</p>
                                        ...
                                        <tr key={transaction.id}>
                                            ...
                                            <td >
                                                {transaction.fromAccountNo == account.accountNo ?
                                                    <div className="text-center sm:text-start" onClick={()=>router.visit(`/accounts/${transaction.toId}`)}>
                                                    ...
                                                    :
                                                    <div className=" text-center sm:text-start" onClick={()=>router.visit(`/accounts/${transaction.fromId}`)}>
